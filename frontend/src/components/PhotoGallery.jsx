          ...
          {filteredPhotos.map((photo) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-2 group-hover:translate-y-0 transition-transform">
                <h3 className="text-xl font-bold mb-2 line-clamp-2">{t(photo.title)}</h3>
                <div className="flex items-center space-x-4 text-sm text-gray-300">
                  ...
                  <span className="flex items-center space-x-1">
                    <Tag size={14} />
                    <span>{t(`gallery.categories.${photo.category}`)}</span>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="p-8 flex flex-col justify-center">
                <h2 className="text-3xl font-bold text-white mb-4">
                  {t(selectedPhoto.title)}
                </h2>
                
                <p className="text-gray-300 mb-6 leading-relaxed">
                  {t(selectedPhoto.description)}
                </p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-2 text-gray-400">
                    <Tag size={18} />
                    <span>{t(`gallery.categories.${selectedPhoto.category}`)}</span>
                  </div>
                </div>
              </div>
            </div>
